  ...
  return (
    <div className="min-h-dvh bg-gray-50">
      ...
      <main className="max-w-lg mx-auto w-full px-4 py-6 space-y-4 pb-28">
        <div className="-mx-4 -mt-6 bg-white border-b border-gray-100 px-5 pt-6 pb-5 text-center">
          <p className="text-xs font-semibold mb-1 text-orange-500">한 살 빼기 챌린지 · 7월 특별 이벤트</p>
          <h1 className="text-2xl font-bold text-gray-900 mb-2">🏆 임원 근력왕을 찾아라!</h1>
