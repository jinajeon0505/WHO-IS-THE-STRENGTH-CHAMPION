...
export default function HomePage() {
  ...
  return (
    <div className="min-h-dvh w-full bg-gray-50 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          <p className="text-xs font-semibold tracking-wide mb-2 text-orange-500">한 살 빼기 챌린지 · 7월 특별 이벤트</p>
          <div className="text-5xl mb-3">🏆</div>
          <h1 className="text-2xl font-bold text-gray-900">임원 근력왕을 찾아라!</h1>
          <div className="text-sm mt-3 leading-relaxed space-y-1 text-gray-600">
            <p>헥토 임원 중 최고의 근력왕은 누구일까요?</p>
            <p>실제 나이보다 근력나이가 가장 젊을 것 같은 한 분에게 투표해주세요!</p>
            <p className="text-xs pt-1 text-gray-400">근력왕을 맞추신 분들 중 추첨을 통해 20분께 소정의 상품을 드립니다~!</p>
          </div>
        </div>
        <LoginForm />
      </div>
